...
private:
  ...
  Eigen::Vector3d dirGatePos;
  Eigen::Vector3d formationPos;

  Direction_t movingDir;
  bool stateFinished;
  bool stateEntered;
  int timestamp = 0;
  double timestampGlobal = 0;
...
private:
  ...
  Eigen::Vector3d calcCohesion(const Perception_t& persception, const UserParams_t& user_params);
  Eigen::Vector3d calcAttraction(const Perception_t& persception, const UserParams_t& user_params);
  Eigen::Vector3d calcSeparation(const Perception_t& persception, const UserParams_t& user_params);
  Eigen::Vector3d calcAvoidance(const Perception_t& persception, const UserParams_t& user_params);
